      ...
      <Card className="p-6">
        ...
        <CardContent className="space-y-3 text-sm">
          ...
          <Link
            ...
            className="inline-flex h-11 w-full items-center justify-center rounded-2xl border border-white/10 px-4 text-sm font-semibold text-slate-100 transition hover:border-brand-400/40 hover:bg-brand-500/10"
          >
